...
export default new Crop({
  ...
  "companions": {
    "good": [
      { "name": "Geraniums", "why": "Geraniums repel Japanese beetles, which are among the most destructive grape pests, defoliating vines rapidly." },
      { "name": "Hyssop", "why": "Hyssop attracts beneficial insects and is traditionally planted near grapes to improve flavor and deter pests." },
      { "name": "Chives", "why": "Chives deter aphids and Japanese beetles with their sulfur-based volatile compounds." },
      { "name": "Nasturtiums", "why": "Nasturtiums act as trap crops for aphids, drawing them away from grape foliage and fruit clusters." },
      { "name": "Clover (cover crop)", "why": "Clover fixes nitrogen between vine rows and attracts beneficial predatory insects that control grape pests." }
    ],
    "bad": [
      { "name": "Cabbage family", "why": "Brassicas are allelopathically incompatible with grapes and compete for the same soil nutrients, reducing vine vigor." },
      { "name": "Radishes", "why": "Radishes can harbor clubroot and other fungal diseases that spread to grape root systems in wet conditions." },
      { "name": "Fennel", "why": "Fennel releases allelopathic chemicals that inhibit the root development and overall growth of grape vines." }
    ]
  },
  ...
  "nutrition": {
    ...
    "fiber": 0.9,
    "vitC": 4,
    "notes": "Rich in resveratrol (antioxidant), vitamin K, and potassium. Red/purple varieties contain significantly more antioxidants than green. Concord grapes are particularly high in polyphenols."
  },
  "size": {
